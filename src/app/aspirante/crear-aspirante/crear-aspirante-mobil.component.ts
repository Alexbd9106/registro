...
@Component({
  selector: 'app-crear-aspirante-mobil',
  templateUrl: './crear-aspirante-mobil.component.html',
  styleUrls: ['./crear-aspirante-mobil.component.css'],
})
export class CrearAspiranteMobilComponent implements OnInit {
...
>>>>>>> 9dc826940ce7a980bb0b81e2b9385866da328c84
  ...
  openDialogTrayectoria() {
    const dialogRef = this.dialog.open(TrayectoriaMobil);
  }

  openTermsAndConditions() {
    const dialogRef = this.dialog.open(TerminosMobil);
  }
...
@Component({
  selector: 'trayectoria-mobil',
  templateUrl: './trayectoria-mobil.html',
  styleUrls: ['./crear-aspirante.component.css'],
})
export class TrayectoriaMobil {
...
@Component({
  selector: 'terminos-mobil',
  templateUrl: './terminos-mobil.html',
  styleUrls: ['./crear-aspirante.component.css'],
})
export class TerminosMobil { }
